...
- `VOX_CUDA_DECODER_INT8=1` enables an experimental INT8 decoder GEMM path (QKV/WO/FFN). This may change outputs slightly; use `./scripts/accuracy_regression.sh` to validate. Default is off even under `VOX_CUDA_FAST=1`.
